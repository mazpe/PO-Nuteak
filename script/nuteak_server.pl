...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{NUTEAK_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{NUTEAK_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
nuteak_server.pl - Catalyst Testserver

=head1 SYNOPSIS

nuteak_server.pl [options]
